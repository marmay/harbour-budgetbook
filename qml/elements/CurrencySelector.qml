...
Selector {
    ...
    addDialog: Component {
        Dialog {
            ...
            signal added(var currency)

            onAccepted: {
                if (currency.text !== "") {
                    Database.addCurrency(currency.text);
                    added(Database.getCurrencyBySymbol(currency.text));
                }
            }
            ...
            Column {
                ...
                TextField {
                    ...
                    width: parent.width
                    placeholderText: qsTr("Currency symbol")
                }
            }
        }
    }
